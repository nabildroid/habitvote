...
import 'package:habitvote/features/premium/application/utils/google_play_utils.dart';
import 'package:habitvote/features/premium/application/utils/payment_gatway_enum.dart';
import 'package:habitvote/features/premium/presentation/screens/stripe_checkout_screen.dart';
  ...
  void checkout() async {
    ...
    if (cubit.state.paymentGatway == PaymentGatway.stripe) {
      final response = await Navigator.of(context)
        ...
        return StripeCheckoutScreen(checkoutWebviewKey: selected.id);
      }));
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFeatureItem(
            ...
            label: 'See who voted on your',
          ),
          _buildFeatureItem(
            icon: Icons.alt_route, // Example icon
            label: 'Detaild Statistics',
            isNew: true,
          ),
          _buildFeatureItem(
            icon: Icons.quiz, // Example icon
            label: 'No need to vote on people',
          ),
          _buildFeatureItem(
