...
class WelcomeScreenVariation {
  ...
  factory WelcomeScreenVariation.fromJson(Map<Object?, Object?> json) {
    return WelcomeScreenVariation(
      variationId: json['variationId'] as String,
      category: json['category'] as String,
      title: json['title'] as String,
      features: (json['features'] as List<dynamic>)
          .map((feature) => FeatureItemData(
                icon: IconData(feature['icon'] as int,
  ...
  factory WelcomeScreenVariation.defaultVariation() {
    return const WelcomeScreenVariation(
