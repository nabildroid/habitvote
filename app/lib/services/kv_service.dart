...
/// [KvService] is for storing user preferences.
class KvService {
  KvService({
  ...
  @override
  String get logIdentifier => '[PreferencesService]';
}

extension PreferenceExtension on KvService {
  static String globalPrefix = "25";
